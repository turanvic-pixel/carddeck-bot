...
class CardStorage:
    ...
    def add_card(self, file_id: str, kind: str = "photo", phash: str | None = None, content_hash: str | None = None) -> int:
    ...
    def add_multi_card(self, file_ids: list, kind: str = "photo", phash: str | None = None, content_hash: str | None = None) -> int:
